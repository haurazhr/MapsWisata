package com.example.mapswisata.Adapter
...
import com.example.mapswisata.DetailWisata
import com.example.mapswisata.Model.modelwisata
import com.example.mapswisata.R
...
class adapterwisata (
    ...
    class MyviewHolder(itemView : View) : RecyclerView.ViewHolder(itemView)  {
        ...
        var imgwisata : ImageView = itemView.findViewById(R.id.imglok)
        var txtnama: TextView = itemView.findViewById(R.id.namalokasi)
        var txtdaerah : TextView = itemView.findViewById(R.id.alamat)
